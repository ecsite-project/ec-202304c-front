...
const ItemList: React.FC = () => {
  ...
  useEffect(() => {
    const getItemsAsync = async () => {
      let url = `http://${BACK_IP}:8080/ec-202404c/items`;
    ...
    return (
      <>
        ...
        >
          ...
          <div
            className="text-3xl mt-2 font-josefin font-medium"
            style={{ display: "flex" }}
          >
            <span className="animate-wave" style={{ animationDelay: "0.1s" }}>
              L
            </span>
            <span className="animate-wave" style={{ animationDelay: "0.2s" }}>
              o
            </span>
            <span className="animate-wave" style={{ animationDelay: "0.3s" }}>
              a
            </span>
            <span className="animate-wave" style={{ animationDelay: "0.4s" }}>
              d
            </span>
            <span className="animate-wave" style={{ animationDelay: "0.5s" }}>
              i
            </span>
            <span className="animate-wave" style={{ animationDelay: "0.6s" }}>
              n
            </span>
            <span className="animate-wave" style={{ animationDelay: "0.7s" }}>
              g
            </span>
          </div>
          <style>
